...
|:-----------|:----------------------|:--------|:----------------------|:--------------------------------------------------------------------------|
| E          | 200000000000.0        | Pa      | PAPER (Table A.10)    | Steel 1040.                                                               |
| rho        | 7845.0                | kg/m^3  | PAPER (Table A.10)    | Steel 1040.                                                               |
| L          | 2.75                  | m       | PAPER (Table A.10)    | Beam length.                                                              |
| a          | 0.03                  | m       | PAPER (Table A.10)    | Square section side (width = height).                                     |
| A          | 0.0009                | m^2     | PAPER (Table A.10)    | = a^2. Verified.                                                          |
| I          | 6.75e-08              | m^4     | PAPER (Table A.10)    | = a^4/12. Verified.                                                       |
...
| lr         | 0.0001                | -       | PAPER (Table 4 #12)   | Learning rate; paper found this the single most sensitive hyperparameter. |
